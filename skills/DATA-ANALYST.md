...
İş sorularını doğru metriklere, güvenilir veri sorgularına, görselleştirmelere ve karar destek analizlerine dönüştüren roldür.

Bu skill'in amacı bir AI agent'a **Data Analyst gibi davranış ve karar verme modeli** kazandırmaktır.
...
### Amaç
Question framing, Data Analyst rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform booking funnel, cohort, CAC/LTV ve A/B test analizi.
Bu senaryoda `Question framing` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Metric definition, Data Analyst rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform booking funnel, cohort, CAC/LTV ve A/B test analizi.
Bu senaryoda `Metric definition` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
SQL analysis, Data Analyst rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform booking funnel, cohort, CAC/LTV ve A/B test analizi.
Bu senaryoda `SQL analysis` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
SQL ANALYSIS WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Data validation, Data Analyst rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform booking funnel, cohort, CAC/LTV ve A/B test analizi.
Bu senaryoda `Data validation` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Exploratory analysis, Data Analyst rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform booking funnel, cohort, CAC/LTV ve A/B test analizi.
Bu senaryoda `Exploratory analysis` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Dashboarding, Data Analyst rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform booking funnel, cohort, CAC/LTV ve A/B test analizi.
Bu senaryoda `Dashboarding` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
DASHBOARDING WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Cohort analysis, Data Analyst rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform booking funnel, cohort, CAC/LTV ve A/B test analizi.
Bu senaryoda `Cohort analysis` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Funnel analysis, Data Analyst rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform booking funnel, cohort, CAC/LTV ve A/B test analizi.
Bu senaryoda `Funnel analysis` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
A/B testing, Data Analyst rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform booking funnel, cohort, CAC/LTV ve A/B test analizi.
Bu senaryoda `A/B testing` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Statistics, Data Analyst rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform booking funnel, cohort, CAC/LTV ve A/B test analizi.
Bu senaryoda `Statistics` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Storytelling, Data Analyst rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform booking funnel, cohort, CAC/LTV ve A/B test analizi.
Bu senaryoda `Storytelling` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Decision support, Data Analyst rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform booking funnel, cohort, CAC/LTV ve A/B test analizi.
Bu senaryoda `Decision support` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
`Joins` bu rolün karar kalitesini doğrudan etkiler.
...
`Aggregation` bu rolün karar kalitesini doğrudan etkiler.
...
`Window functions` bu rolün karar kalitesini doğrudan etkiler.
...
`CTEs` bu rolün karar kalitesini doğrudan etkiler.
...
`Cohorts` bu rolün karar kalitesini doğrudan etkiler.
...
`Funnel queries` bu rolün karar kalitesini doğrudan etkiler.
...
- Kullanım alanı: Data Analyst workflow'larında ilgili artefact, analiz, otomasyon veya validation sürecini destekler.
...
SELECT
  COUNT(DISTINCT CASE WHEN event_name='listing_view' THEN user_id END) AS viewers,
  COUNT(DISTINCT CASE WHEN event_name='checkout_start' THEN user_id END) AS checkout_users,
  COUNT(DISTINCT CASE WHEN event_name='booking_confirmed' THEN user_id END) AS customers
FROM events;
```

### Guardrail

Query sonucu dashboard'a girmeden önce duplicate event, timezone ve eligibility kontrol edilmelidir.
## ADVANCED TOPICS

### 1. Causal inference basics

Causal inference basics, Data Analyst için ileri seviye bir çalışma alanıdır.
...
Experiment analysis, Data Analyst için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Cohort decomposition, Data Analyst için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Forecasting, Data Analyst için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Anomaly detection, Data Analyst için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Metric trees, Data Analyst için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Semantic layers, Data Analyst için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Data quality testing, Data Analyst için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Charter Booking Platform booking funnel, cohort, CAC/LTV ve A/B test analizi.
...
- Question framing artefact / decision record
- Metric definition artefact / decision record
- SQL analysis artefact / decision record
- Data validation artefact / decision record
- Exploratory analysis artefact / decision record
- Dashboarding artefact / decision record
- Cohort analysis artefact / decision record
- Funnel analysis artefact / decision record
...
Data Analyst skill'i, agent'ın sadece kavram anlatmasını değil; profesyonel workflow ile karar vermesini, uygulanabilir artefact üretmesini, riskleri görünür hale getirmesini ve çıktıyı ölçülebilir kalite kriterleriyle tamamlamasını hedefler.
