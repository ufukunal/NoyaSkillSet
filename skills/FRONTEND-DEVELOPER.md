...
Web arayüzlerini component mimarisi, state yönetimi, performans, erişilebilirlik, test ve güvenlik gereksinimleriyle birlikte geliştiren roldür.

Bu skill'in amacı bir AI agent'a **Frontend Developer gibi davranış ve karar verme modeli** kazandırmaktır.
...
### Amaç
Component architecture, Frontend Developer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform responsive search, listing ve checkout frontend'i.
Bu senaryoda `Component architecture` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
State management, Frontend Developer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform responsive search, listing ve checkout frontend'i.
Bu senaryoda `State management` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
STATE MANAGEMENT WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Routing, Frontend Developer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform responsive search, listing ve checkout frontend'i.
Bu senaryoda `Routing` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Forms, Frontend Developer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform responsive search, listing ve checkout frontend'i.
Bu senaryoda `Forms` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Data fetching, Frontend Developer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform responsive search, listing ve checkout frontend'i.
Bu senaryoda `Data fetching` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
DATA FETCHING WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Accessibility, Frontend Developer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
### Amaç
Responsive UI, Frontend Developer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform responsive search, listing ve checkout frontend'i.
Bu senaryoda `Responsive UI` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
RESPONSIVE UI WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Performance, Frontend Developer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
### Amaç
Error states, Frontend Developer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform responsive search, listing ve checkout frontend'i.
Bu senaryoda `Error states` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
ERROR STATES WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Testing, Frontend Developer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
### Amaç
Frontend security, Frontend Developer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform responsive search, listing ve checkout frontend'i.
Bu senaryoda `Frontend security` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
FRONTEND SECURITY WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Observability, Frontend Developer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
`Composition` bu rolün karar kalitesini doğrudan etkiler.
...
`Controlled/uncontrolled` bu rolün karar kalitesini doğrudan etkiler.
...
`Props contracts` bu rolün karar kalitesini doğrudan etkiler.
...
`Accessibility` bu rolün karar kalitesini doğrudan etkiler.
...
`Error/empty/loading states` bu rolün karar kalitesini doğrudan etkiler.
...
- Kullanım alanı: Frontend Developer workflow'larında ilgili artefact, analiz, otomasyon veya validation sürecini destekler.
...
Server components, Frontend Developer için ileri seviye bir çalışma alanıdır.
...
Hydration, Frontend Developer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Streaming, Frontend Developer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Micro-frontends, Frontend Developer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Design tokens, Frontend Developer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Bundle analysis, Frontend Developer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Edge rendering, Frontend Developer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Optimistic UI, Frontend Developer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Offline patterns, Frontend Developer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Charter Booking Platform responsive search, listing ve checkout frontend'i.
...
- Component architecture artefact / decision record
- State management artefact / decision record
- Routing artefact / decision record
- Forms artefact / decision record
- Data fetching artefact / decision record
- Accessibility artefact / decision record
- Responsive UI artefact / decision record
- Performance artefact / decision record
...
Frontend Developer skill'i, agent'ın sadece kavram anlatmasını değil; profesyonel workflow ile karar vermesini, uygulanabilir artefact üretmesini, riskleri görünür hale getirmesini ve çıktıyı ölçülebilir kalite kriterleriyle tamamlamasını hedefler.
