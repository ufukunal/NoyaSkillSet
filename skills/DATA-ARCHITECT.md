...
must_escalate:
  ...
  - "retention/compliance exception"
  - "cross-domain ownership conflict"
done_when:
  - "grain/ownership are explicit"
  - "quality rules exist"
  - "lineage is defined"
  - "privacy/retention are addressed"
---
...
# VERİ MİMARI (DATA ARCHITECT) - KAPSAMLI SKILL
...
Operasyonel ve analitik verinin modellerini, platformlarını, entegrasyonlarını, yönetişimini ve yaşam döngüsünü tasarlayan roldür.

Bu skill'in amacı bir AI agent'a **Data Architect gibi davranış ve karar verme modeli** kazandırmaktır.
...
### Amaç
Conceptual modeling, Data Architect rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform operasyonel booking verisinden analitik warehouse ve BI katmanı tasarımı.
Bu senaryoda `Conceptual modeling` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
CONCEPTUAL MODELING WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Logical modeling, Data Architect rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform operasyonel booking verisinden analitik warehouse ve BI katmanı tasarımı.
Bu senaryoda `Logical modeling` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
LOGICAL MODELING WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Physical modeling, Data Architect rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform operasyonel booking verisinden analitik warehouse ve BI katmanı tasarımı.
Bu senaryoda `Physical modeling` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
PHYSICAL MODELING WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Operational data, Data Architect rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform operasyonel booking verisinden analitik warehouse ve BI katmanı tasarımı.
Bu senaryoda `Operational data` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
OPERATIONAL DATA WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Warehouse/lakehouse, Data Architect rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform operasyonel booking verisinden analitik warehouse ve BI katmanı tasarımı.
Bu senaryoda `Warehouse/lakehouse` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
WAREHOUSE/LAKEHOUSE WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
ETL/ELT, Data Architect rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform operasyonel booking verisinden analitik warehouse ve BI katmanı tasarımı.
Bu senaryoda `ETL/ELT` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Metadata, Data Architect rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform operasyonel booking verisinden analitik warehouse ve BI katmanı tasarımı.
Bu senaryoda `Metadata` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Governance, Data Architect rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform operasyonel booking verisinden analitik warehouse ve BI katmanı tasarımı.
Bu senaryoda `Governance` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Quality, Data Architect rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform operasyonel booking verisinden analitik warehouse ve BI katmanı tasarımı.
Bu senaryoda `Quality` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Lineage, Data Architect rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform operasyonel booking verisinden analitik warehouse ve BI katmanı tasarımı.
Bu senaryoda `Lineage` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Master data, Data Architect rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform operasyonel booking verisinden analitik warehouse ve BI katmanı tasarımı.
Bu senaryoda `Master data` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Retention, Data Architect rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform operasyonel booking verisinden analitik warehouse ve BI katmanı tasarımı.
Bu senaryoda `Retention` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
`Conceptual` bu rolün karar kalitesini doğrudan etkiler.
...
`Logical` bu rolün karar kalitesini doğrudan etkiler.
...
`Physical` bu rolün karar kalitesini doğrudan etkiler.
...
`Normalization` bu rolün karar kalitesini doğrudan etkiler.
...
`Denormalization` bu rolün karar kalitesini doğrudan etkiler.
...
`Dimensional modeling` bu rolün karar kalitesini doğrudan etkiler.
...
- Kullanım alanı: Data Architect workflow'larında ilgili artefact, analiz, otomasyon veya validation sürecini destekler.
...
Dimensional model business grain açık tanımlanmadan oluşturulmamalıdır.
## ADVANCED TOPICS

### 1. Data mesh

Data mesh, Data Architect için ileri seviye bir çalışma alanıdır.
...
Lakehouse, Data Architect için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
CDC, Data Architect için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
SCD, Data Architect için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Data contracts, Data Architect için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Medallion architecture, Data Architect için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Semantic layers, Data Architect için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
PII governance, Data Architect için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
### 9. Lineage automation

Lineage automation, Data Architect için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Charter Booking Platform operasyonel booking verisinden analitik warehouse ve BI katmanı tasarımı.
...
- Conceptual modeling artefact / decision record
- Logical modeling artefact / decision record
- Physical modeling artefact / decision record
- Operational data artefact / decision record
- Warehouse/lakehouse artefact / decision record
- ETL/ELT artefact / decision record
- Metadata artefact / decision record
- Governance artefact / decision record
...
Data Architect skill'i, agent'ın sadece kavram anlatmasını değil; profesyonel workflow ile karar vermesini, uygulanabilir artefact üretmesini, riskleri görünür hale getirmesini ve çıktıyı ölçülebilir kalite kriterleriyle tamamlamasını hedefler.
