...
Yazılım teslimini otomatikleştiren, altyapıyı kodla yöneten, deployment güvenilirliğini ve gözlemlenebilirliği geliştiren roldür.

Bu skill'in amacı bir AI agent'a **DevOps Engineer gibi davranış ve karar verme modeli** kazandırmaktır.
...
### Amaç
CI/CD, DevOps Engineer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform için CI/CD, IaC, container deployment ve monitoring pipeline'ı.
Bu senaryoda `CI/CD` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Infrastructure as Code, DevOps Engineer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform için CI/CD, IaC, container deployment ve monitoring pipeline'ı.
Bu senaryoda `Infrastructure as Code` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
INFRASTRUCTURE AS CODE WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Containers, DevOps Engineer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform için CI/CD, IaC, container deployment ve monitoring pipeline'ı.
Bu senaryoda `Containers` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Orchestration, DevOps Engineer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform için CI/CD, IaC, container deployment ve monitoring pipeline'ı.
Bu senaryoda `Orchestration` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
ORCHESTRATION WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Secrets, DevOps Engineer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform için CI/CD, IaC, container deployment ve monitoring pipeline'ı.
Bu senaryoda `Secrets` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Artifact management, DevOps Engineer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform için CI/CD, IaC, container deployment ve monitoring pipeline'ı.
Bu senaryoda `Artifact management` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
ARTIFACT MANAGEMENT WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Deployment strategy, DevOps Engineer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform için CI/CD, IaC, container deployment ve monitoring pipeline'ı.
Bu senaryoda `Deployment strategy` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.
...
### Amaç
Observability, DevOps Engineer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
### Amaç
SRE practices, DevOps Engineer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform için CI/CD, IaC, container deployment ve monitoring pipeline'ı.
Bu senaryoda `SRE practices` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
SRE PRACTICES WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Backup/restore, DevOps Engineer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform için CI/CD, IaC, container deployment ve monitoring pipeline'ı.
Bu senaryoda `Backup/restore` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
BACKUP/RESTORE WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Cost controls, DevOps Engineer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform için CI/CD, IaC, container deployment ve monitoring pipeline'ı.
Bu senaryoda `Cost controls` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
COST CONTROLS WORKSHEET
==============================
Objective:
Context:
Inputs:
...
### Amaç
Platform security, DevOps Engineer rolünün çekirdek sorumluluklarından biridir. Amaç yalnızca çıktı üretmek değil, doğru karar bağlamını kurmak ve downstream ekiplerin yanlış yorum riskini azaltmaktır.
...
**Senaryo:** Charter Booking Platform için CI/CD, IaC, container deployment ve monitoring pipeline'ı.
Bu senaryoda `Platform security` sorumluluğu için agent önce mevcut durumu çıkarır, sonra karar kriterlerini belirler, alternatifleri karşılaştırır ve uygulanabilir artefact üretir.

### Copy-Paste Mini Template

```text
PLATFORM SECURITY WORKSHEET
==============================
Objective:
Context:
Inputs:
...
`Lint` bu rolün karar kalitesini doğrudan etkiler.
...
`Unit tests` bu rolün karar kalitesini doğrudan etkiler.
...
`Security scan` bu rolün karar kalitesini doğrudan etkiler.
...
`Build` bu rolün karar kalitesini doğrudan etkiler.
...
`Artifact` bu rolün karar kalitesini doğrudan etkiler.
...
`Integration` bu rolün karar kalitesini doğrudan etkiler.
...
`Deploy` bu rolün karar kalitesini doğrudan etkiler.
...
`Smoke test` bu rolün karar kalitesini doğrudan etkiler.
...
- Kullanım alanı: DevOps Engineer workflow'larında ilgili artefact, analiz, otomasyon veya validation sürecini destekler.
...
```text
Build -> Test -> Scan -> Package -> Deploy Staging
      -> Smoke -> Approval/Policy -> Production -> Verify
```
## ADVANCED TOPICS

### 1. GitOps

GitOps, DevOps Engineer için ileri seviye bir çalışma alanıdır.
...
Progressive delivery, DevOps Engineer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Blue/green, DevOps Engineer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Canary, DevOps Engineer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Policy as code, DevOps Engineer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Platform engineering, DevOps Engineer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
SLOs, DevOps Engineer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Error budgets, DevOps Engineer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Chaos engineering, DevOps Engineer için ileri seviye bir çalışma alanıdır.
Bu konu uygulanırken yalnızca pattern adı vermek yerine hangi problemde kullanıldığı, hangi maliyetleri getirdiği ve hangi durumda kullanılmaması gerektiği açıklanmalıdır.
...
Charter Booking Platform için CI/CD, IaC, container deployment ve monitoring pipeline'ı.
...
- CI/CD artefact / decision record
- Infrastructure as Code artefact / decision record
- Containers artefact / decision record
- Orchestration artefact / decision record
- Secrets artefact / decision record
- Artifact management artefact / decision record
- Deployment strategy artefact / decision record
- Observability artefact / decision record
...
DevOps Engineer skill'i, agent'ın sadece kavram anlatmasını değil; profesyonel workflow ile karar vermesini, uygulanabilir artefact üretmesini, riskleri görünür hale getirmesini ve çıktıyı ölçülebilir kalite kriterleriyle tamamlamasını hedefler.
